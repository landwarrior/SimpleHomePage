...
<template>
    <div class="relative inline-block">
        <button
            ...
            class="flex items-center gap-2 px-4 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all"
            aria-label="テーマを切り替え"
        >
            <!-- アイコン -->
            ...
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300"> {{ currentTheme === 'light' ? 'ライト' : currentTheme === 'dark' ? 'ダーク' : 'システム' }}</span>
